...
describe('NegotiatedProtocolVersions', () => {
    ...
    it('negotiates versions as expected', () => {
        expect(negotiatedProtocolVersions.getNegotiatedProtocolVersion('peer2')).toEqual({
            controlLayerVersion: 2,
            messageLayerVersion: 32
        })
        expect(negotiatedProtocolVersions.getNegotiatedProtocolVersion('peer3')).toEqual({
